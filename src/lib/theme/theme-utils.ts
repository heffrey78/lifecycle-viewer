import type { Theme, RequirementStatus, TaskStatus, ArchitectureStatus, Priority, EffortSize, RiskLevel, ColorVariant } from './theme-types.js';
...
export function getArchitectureStatusColors(status: ArchitectureStatus, theme: Theme): ColorVariant {
...
export function getArchitectureStatusColorClasses(status: ArchitectureStatus, theme: Theme): string {
...
export function getArchitectureStatusHoverClasses(status: ArchitectureStatus, theme: Theme): string {
  const colors = getArchitectureStatusColors(status, theme);
  return colors.hover || '';
}
