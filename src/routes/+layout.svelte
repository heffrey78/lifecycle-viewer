...
<div
	class="min-h-screen"
	style="background-color: {$currentTheme.base.background}; color: {$currentTheme.base.foreground};"
>
	<!-- Navigation Sidebar -->
	<div
		class="fixed inset-y-0 left-0 w-64 shadow-lg"
	...
	>
		<div class="flex flex-col h-full">
			...
			<div
				...
				style="background-color: {$currentTheme.base.accent}; color: {$currentTheme.id ===
				'high-contrast'
					? 'black'
					: 'white'};"
			>
			...
			<div class="px-4 py-2 border-t" style="border-color: {$currentTheme.base.border};">
				<p class="text-xs text-center" style="color: {$currentTheme.base.muted};">
						...
						<div class="relative">
							...
							{#if showThemeDropdown}
								<div
									...
									style="background-color: {$currentTheme.base
										.background}; border-color: {$currentTheme.base.border};"
								>
									{#each Object.values(defaultThemes) as theme}
										...
										>
											<div
												...
												style="background-color: {theme.base.accent}; border-color: {$currentTheme
													.base.border};"
											></div>
											<div>
