      ...
      <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
          ...
          <div class="ml-4">
            ...
            <p class="text-sm text-gray-500">
              {Object.entries(projectMetrics.architecture.by_status).filter(([, count]) => ['Accepted', 'Implemented'].includes(status) && count > 0).length} Decisions
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="bg-white rounded-lg shadow">
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a href="/requirements" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
          ...
          <a href="/tasks" class="flex items-center p-4 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors">
          ...
          <a href="/architecture" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
