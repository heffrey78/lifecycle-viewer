...
<div class="max-w-4xl">
  <div class="bg-white rounded-lg shadow-md p-6">
    ...
    <!-- Connection Status -->
    <div class="mb-8 p-4 rounded-lg border {connectionStatus === 'connected' ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}">
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-2">
        ...
        <div class="p-3 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-900 font-mono">
      ...
      <div class="space-y-4">
        ...
        <p class="text-sm text-gray-500">
          Select a lifecycle.db file to switch between different projects. The file will be validated before switching.
        </p>
      </div>
